export const ON_SCORE_FORM_CLEAR = 'on-score-form-clear'
export const ON_SCORE_FORM_FIELD_CHANGE = 'on-score-form-field-change'

export const SCORES_GET_REQUEST = 'scores-get-request'
